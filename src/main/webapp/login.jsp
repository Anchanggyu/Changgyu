...
<body>
  ...
  <section id="hero" class="clearfix">
  	...
  	<div class = "shadow-lg p-3 mb-5 bg-body rounded position-absolute top-50 start-50 translate-middle">
		<a href = "login.jsp"><h3 style = "text-align: center;"><code>로그인</code></h3></a><br/>
		<form class="row g-3" method = "post" action = "function/loginpro.jsp">
			...
			<div class = "row">
				<div class="form-group col-lg-6 col-sm-12 text-lg-start">
					<a href="signup.jsp"><button class = "btn btn-primary" type = "button">회원가입</button></a>
			 	</div>
