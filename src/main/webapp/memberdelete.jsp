...
<body>
  ...
  <section id="hero" class="clearfix">
  	...
  	<div class = "shadow-lg p-3 mb-5 bg-body rounded position-absolute top-50 start-50 translate-middle">
		<a href = "memberdelete.jsp"><h3 style = "text-align: center;"><code>회원탈퇴</code></h3></a><br/>
		<form class = "row g-3" method = "post" action = "function/memberdeletepro.jsp">
		  <div class="col-12">
		  ...
		  <div class="col-lg-12 text-lg-end">
		  	<button onclick = "return confirm('정말 탈퇴하시겠습니까?')" type = "submit" class = "btn btn-danger">탈퇴</button>
			<a href = "index.jsp"><button class = "btn btn-info" type = "button">취소</button></a>
		  </div>
		</form>
	</div>
	</div>
