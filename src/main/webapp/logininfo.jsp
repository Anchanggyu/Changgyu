...
<body>
	<%
		...
		MemberDto memberdto = new MemberDao().getMem(id);
	%>
...
<section id="hero" class="clearfix">
	<div class="container"> 
		...
		<table class="table table-striped"> 
			...
			<tbody> 
			<tr>
				<th><%= memberdto.getId() %></th> 
				<th><%= memberdto.getPw() %></th> 
				<th><%= memberdto.getName() %></th>
				<th><%= memberdto.getEmail() %></th>
				<th><%= memberdto.getTel() %></th> 			
			</tr> 		
			</tbody> 
		</table> 
		<div class="form-group col-lg-12 text-lg-end">
  				<a href="memberupdate.jsp"><button class = "btn btn-danger" type = "button">정보수정</button></a>
		</div>
  		</div>
  	</div>
</section>
