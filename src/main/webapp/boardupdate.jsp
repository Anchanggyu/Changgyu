...
<section id="hero" class="clearfix">
	<div class="container">
		<div class="row">
			<form method="post" action="function/boardupdatepro.jsp?bookID=<%= bookID%>">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr>
							<td><input type = "text" class = "form-control" placeholder = "글 제목" name = "bookTitle" maxlength = "50" value = "<%= bookdto.getBookTitle() %>"></td>
						</tr>
						<tr>
							<td><textarea class = "form-control" placeholder = "글 내용" name = "bookContent" maxlength = "2048" style = "height : 350px;"><%= bookdto.getBookContent() %></textarea></td>
						</tr>
					</tbody>
				</table>
